...
Mandatory: Prototype: int create_file(const char *filename, char *text_content);
...
Mandatory: Prototype: int append_text_to_file(const char *filename, char *text_content);
...
Mandatory: Usage: cp file_from file_to
...
Advanced: Usage: elf_header elf_filename
